    ...
    <>
      <div
        className={`p-4 rounded-lg shadow ${
          task.completed ? "bg-red-100" : "bg-white"
        } h-[102%] w-[95%]`}
      >
        {isEditing ? (
          <>
            ...
            <div className="flex justify-between mt-2">
              <button
                onClick={handleSave}
                className="bg-blue-500 font-medium text-white px-3 py-2 rounded-md"
              >
                Save
              </button>
              <button
                onClick={() => setIsEditing(false)}
                className="bg-gray-500 font-medium text-white px-3 py-2 rounded-md"
              >
                Cancel
              </button>
            </div>
          ...
          <>
            ...
            <hr
              className={`mt-4 mb-5 border-solid border rounded-lg w-full  ${
                task.completed
                  ? "border-red-500"
              ...
              <div className="flex space-x-4">
                {!task.completed && (
                  <FaRegStar
                    ...
                    className={`text-2xl text-gray-500 dark:text-gray-900`}
                  />
                )}
                <HiTrash
