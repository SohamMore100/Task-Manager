    ...
    <form onSubmit={handleSubmit} className="p-3">
      ...
      <div className="flex justify-between mt-1">
        <button
          ...
          className="bg-blue-500 text-white font-medium px-4 py-1 rounded-md dark:bg-zinc-100 dark:text-blue-600 "
        >
          Cancel
        </button>
        <button
          type="submit"
          className="bg-green-500 text-white font-medium px-4 py-1 rounded-md dark:bg-zinc-100 dark:text-green-600 dark:font-semibold"
        >
          Add Task
        </button>
      </div>
